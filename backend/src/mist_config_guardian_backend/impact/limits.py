...
MAX_CHECKPOINT_EVIDENCE = 3 * MAX_WLAN_TARGETS + 2 * MAX_PORT_TARGETS + MAX_NEIGHBOR_TARGETS

# Independent spending ceiling, not a promise to fund every possible checkpoint.
# A maximal eighteen-check plan funds three full checkpoints and two more reads.
MAX_AUDIT_CALLS = 56
